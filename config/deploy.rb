set :application, "mi_locations"
set :repo_url, "git@github.com:dschmura/mi_locations.git"
set :user, "deployer"
...
set :puma_bind, "unix://#{shared_path}/tmp/sockets/mi_locations-puma.sock"
...
namespace :deploy do
  ...
  task :upload_data do
    on roles :app do
      upload! "uploads", shared_path.to_s, recursive: true
    end
  end
